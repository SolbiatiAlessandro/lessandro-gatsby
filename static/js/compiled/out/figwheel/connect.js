...
if(cljs.core.truth_(three_body.core.on_js_reload)){
return cljs.core.apply.call(null,three_body.core.on_js_reload,x__30506__auto__);
} else {
return figwheel.client.utils.log.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),["Figwheel: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"on-jsload","on-jsload",-395756602))," hook '","three-body.core/on-js-reload","' is missing"].join(''));
}
};
...
//# sourceMappingURL=connect.js.map?rel=1605146147324
